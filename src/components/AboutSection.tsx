    ...
    <section id='section-about' className='about'>
      ...
      <div
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Постоянно совершенствую свои знания в области IT-Технологий, параллельно повышаю уровень английского, легко нахожу общий язык с коллегами. И в целом люблю работать в команде
        </motion.p>
      </div>
